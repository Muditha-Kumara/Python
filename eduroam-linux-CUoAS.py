...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Centria University of Applied Sciences"
Config.profilename = ""
Config.url = "http://www.centria.fi/eduroam/"
Config.email = "helpdesk@centria.fi"
Config.title = "eduroam CAT"
Config.server_match = "centria-CA"
